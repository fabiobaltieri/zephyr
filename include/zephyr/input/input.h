 ...
 *                @kconfig{INPUT_MODE_SYNCHRONOUS} is used.
 ...
 * @retval -EINVAL if type is outside of the allowed range.
 */
 ...
 * been emptied. Always returns true if @kconfig{INPUT_MODE_SYNCHRONOUS} is
 * enabled.
 */
