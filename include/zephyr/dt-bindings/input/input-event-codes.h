...
#define INPUT_EV_REL 0x0002
#define INPUT_EV_ABS 0x0003
#define INPUT_EV_MSC 0x0004
#define INPUT_EV_VENDOR_START 0x0100
#define INPUT_EV_VENDOR_STOP 0x01ff
#define INPUT_EV_SYN 0x8000
/** @} */
