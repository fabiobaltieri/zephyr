...
static void input_cb_filtered(struct input_event *evt, bool sync)
{
...
static void input_cb_unfiltered(struct input_event *evt, bool sync)
{
...
static void input_cb_last_event(struct input_event *evt, bool sync)
{
